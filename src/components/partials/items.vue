<template>
  <div class="flex flex-col">
    <ui-menu-item :index="0" class="mb-4" @click="event('click', $event)"/>
    <ui-menu-item class="ml-2" :index="1" :selected="true" @click="event('click', $event)">
      <template #icon>
        <svg
...
<script>
import UiMenuItem from '../../ui/atoms/ui-menu-item';
